...
%POPULAÇÃO INICIAL
    ...
    % Melhores fitness
        ...
        %primeira geração
        first_fitness = feval('my_fitness',...
            [population(1,1)...
             population(1,2)...
             population(1,3)...
             population(1,4)...
...
for i = 1:1:maximal_generation
    ...
    for k = 1:1:population_size
        ...
        pop = [pop; [population(k,1) population(k,2)]]; %Todos os individuos de todas as gerações
    ...
    pop_fitness = [pop_fitness ; feval(fitness_function, [pop(i:i*100,1) pop(i:i*100,2)])];
    %pop = [pop; population];
%   % Variation population
